...
const DoubleLink_1 = require("./DoubleLink");
describe('LinkedList', function () {
    it('should append/prepend/drop', function () {
        const l1 = new DoubleLink_1.DoubleLink();
        const l2 = new DoubleLink_1.DoubleLink();
        const n1 = new DoubleLink_1.DoubleLinkNode(1);
        const n2 = new DoubleLink_1.DoubleLinkNode(2);
        const n3 = new DoubleLink_1.DoubleLinkNode(3);
        const n4 = new DoubleLink_1.DoubleLinkNode(4);
        const n5 = new DoubleLink_1.DoubleLinkNode(5);
        l1.append(n1);
