...
export declare const isMap: ((value: unknown) => false) | ((value: unknown) => value is Map<any, any>);
...
export declare const isURLSearchParams: (input: unknown) => input is URLSearchParams;
export declare const isReadableStream: (input: unknown) => input is ReadableStream<any>;
