...
describe('number format', function () {
    it('should format correctly', function () {
        ...
        expect(itos(0xfffffffffffff, 2)).toBe('1111111111111111111111111111111111111111111111111111');
        ...
        expect(stoi('1111111111111111111111111111111111111111111111111111', 2)).toBe(0xfffffffffffff);
        expect(stoi('?')).toBeNaN();
        var d = Date.now() * 102;
        console.log(d, itos(d));
    });
});
//# sourceMappingURL=numberFormat.spec.js.map